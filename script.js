...
function insertNewRecord(data) {
    ...
    // cell7 = innerHTML = `<a onClick="onEdit(this)"><i class="fa fa-pencil" style="font-size:24px"></i>,/a>
...
function onEdit(td) {
    ...
    document.getElementById("genderr").value = selectedRow.cells[6].innerHTML;
}
// Update Record
